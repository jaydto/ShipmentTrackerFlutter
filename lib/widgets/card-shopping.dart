                ...
                children: [
                  ...
                  TextButton(
                    ...
                    style: TextButton.styleFrom(
                      foregroundColor: ShipmentTrackerColors.white,
                      backgroundColor: ShipmentTrackerColors.initial,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                                ...
                                style: TextStyle(
                                    color: stock == true
                                        ? ShipmentTrackerColors.success
                                        : ShipmentTrackerColors.error,
                                    fontSize: 12,
      ...
      child: DropdownButtonHideUnderline(
        child: Theme(
          data: Theme.of(context).copyWith(
            canvasColor: ShipmentTrackerColors.initial,
          ),
          child: DropdownButton<String>(
            ...
            onChanged: (String? newValue) {
              setState(() {
                dropdownValue =
                    newValue ?? ''; // Convert nullable String to non-nullable
              });
            },
